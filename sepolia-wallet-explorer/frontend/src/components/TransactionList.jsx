      ...
      <div className="w-full max-w-6xl mx-auto p-8 text-center bg-black border-2 border-white font-mono space-y-4">
        ...
        <div className="bg-black border border-neutral-800 p-4 max-w-lg mx-auto text-left text-xs text-neutral-400 space-y-2">
          ...
          <div className="flex items-start gap-2">
            ...
            <span>Or click below to view the entire historical archive on Etherscan.</span>
          </div>
        </div>
        ...
        <div className="pt-2">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-black font-bold text-xs uppercase hover:bg-black hover:text-white border-2 border-white transition-all"
          >
    ...
    <div className="w-full max-w-6xl mx-auto space-y-3 font-mono">
      <div className="flex items-center justify-between px-1">
        <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-400">
          [ Recorded Transactions: {data.transactions.length} ]
        </h3>
